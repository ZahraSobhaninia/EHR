...
def main_train(config_path):
    ...
    trainer.train()
##
    logger.info("Extracting representations from final model")

    if cfg.trainer_args.get("save_representations", False):
        trainer._extract_and_save_representations("Final")
##
    logger.info("Done")
